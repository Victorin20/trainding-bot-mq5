...
uint buyLimit(const int position, const double volume, const int combination_number)
  {
//--- prepare a request
   double price = startPrice + position*points;
...
uint blackbuyLimit(const int position, const double volume,const double stoploss, const double takeprofit, const int combination_number)
  {
